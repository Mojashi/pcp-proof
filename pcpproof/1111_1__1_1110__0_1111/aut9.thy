...
abbreviation transition::"State \<Rightarrow> alphabet \<Rightarrow> State" where
  ...
  ((aut9.State_R aut9.state_level1_Leaf), C1) => (aut9.State_R aut9.state_level1_Leaf)|
  ((aut9.State_L aut9.state_level1_Leaf), C0) => (aut9.State_L aut9.state_level1_Leaf)|
  ((aut9.State_L aut9.state_level1_Leaf), C1) => (aut9.State_R aut9.state_level1_Leaf)|
...
definition aut9::"(alphabet, State) da" where
 "aut9 \<equiv> da aut9.State_Leaf transition {(aut9.State_L aut9.state_level1_Leaf)}"
end