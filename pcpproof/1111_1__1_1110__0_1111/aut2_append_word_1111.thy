theory aut2_append_word_1111 
  imports Main "aut2" "aut17" "aut2_append_ch_1" "aut11_append_ch_1" "aut13_append_ch_1" "aut14_append_ch_1"
begin

lemma "aut2_append_word_1111": "lang (append_word aut2 [C1,C1,C1,C1]) = lang aut17"
proof -
  ...
  have "lang (append_word_rev aut2 [C1,C1,C1,C1]) = lang (append_ch (append_word_rev aut2 [C1,C1,C1]) C1)"
    by (simp only: append_word_lang_rev_to_ch[of "aut2" C1 "[C1,C1,C1]"] )
  then have "lang (append_word_rev aut2 [C1,C1,C1,C1]) = lang (append_ch aut14 C1)"
    by (simp only: L3 append_ch_hom[of "append_word_rev aut2 [C1,C1,C1]" aut14 C1] )
  then have L4:"lang (append_word_rev aut2 [C1,C1,C1,C1]) = lang aut17"
    by (simp only: aut14_append_ch_1 )


  have "rev [C1,C1,C1,C1] = [C1,C1,C1,C1]" by simp
  then have "append_word aut2 [C1,C1,C1,C1] = append_word_rev aut2 [C1,C1,C1,C1]" 
    by (simp only: append_word_rev_is_rev[of aut2 "[C1,C1,C1,C1]"])
