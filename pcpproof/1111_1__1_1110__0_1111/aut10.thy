...
abbreviation transition::"State \<Rightarrow> alphabet \<Rightarrow> State" where
  ...
  ((aut10.State_R aut10.state_level1_Leaf), C1) => (aut10.State_L aut10.state_level1_Leaf)|
  ((aut10.State_L aut10.state_level1_Leaf), C0) => (aut10.State_R aut10.state_level1_Leaf)|
