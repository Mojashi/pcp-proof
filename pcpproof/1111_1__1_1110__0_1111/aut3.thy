...
obtains "s = (aut3.State_L aut3.state_level1_Leaf)" |
"s = aut3.State_Leaf" |
...
abbreviation transition::"State \<Rightarrow> alphabet \<Rightarrow> State" where
  ...
  (aut3.State_Leaf, C0) => (aut3.State_R aut3.state_level1_Leaf)|
  ((aut3.State_R aut3.state_level1_Leaf), C1) => (aut3.State_L aut3.state_level1_Leaf)|
  ((aut3.State_R aut3.state_level1_Leaf), C0) => (aut3.State_R aut3.state_level1_Leaf)|
  ((aut3.State_L aut3.state_level1_Leaf), C1) => (aut3.State_L aut3.state_level1_Leaf)|
  ((aut3.State_L aut3.state_level1_Leaf), C0) => (aut3.State_R aut3.state_level1_Leaf)"

definition aut3::"(alphabet, State) da" where
 "aut3 \<equiv> da aut3.State_Leaf transition {(aut3.State_L aut3.state_level1_Leaf)}"
end