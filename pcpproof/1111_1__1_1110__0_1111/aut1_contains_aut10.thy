...
definition aut1_aut10_Invariant::"(aut1.State\<times>aut10.State) set" where
  "aut1_aut10_Invariant \<equiv> { ((aut1.State_R (aut1.state_level1_L aut1.state_level2_Leaf)), (aut10.State_L aut10.state_level1_Leaf)), ((aut1.State_L aut1.state_level1_Leaf), (aut10.State_L aut10.state_level1_Leaf)), ((aut1.State_L (aut1.state_level1_R aut1.state_level2_Leaf)), (aut10.State_L aut10.state_level1_Leaf)), ((aut1.State_R aut1.state_level1_Leaf), (aut10.State_R aut10.state_level1_Leaf)), ((aut1.State_R (aut1.state_level1_R aut1.state_level2_Leaf)), (aut10.State_L aut10.state_level1_Leaf)), (aut1.State_Leaf, (aut10.State_L aut10.state_level1_Leaf)), ((aut1.State_L (aut1.state_level1_L aut1.state_level2_Leaf)), (aut10.State_R aut10.state_level1_Leaf)) }"
