...
definition aut5_aut4_append_char_automaton_1_Invariant::"(aut5.State\<times>aut4_append_char_automaton_1.State) set" where
  "aut5_aut4_append_char_automaton_1_Invariant \<equiv> { ((aut5.State_R (aut5.state_level1_L aut5.state_level2_Leaf)), (state_r (aut4.State_L (aut4.state_level1_R aut4.state_level2_Leaf)))), (aut5.State_Leaf, (state_r (aut4.State_R (aut4.state_level1_R aut4.state_level2_Leaf)))), ((aut5.State_L (aut5.state_level1_R aut5.state_level2_Leaf)), (state_r (aut4.State_R (aut4.state_level1_L aut4.state_level2_Leaf)))), ((aut5.State_L (aut5.state_level1_R aut5.state_level2_Leaf)), (state_l (aut4.State_L (aut4.state_level1_L aut4.state_level2_Leaf)))), ((aut5.State_R (aut5.state_level1_R aut5.state_level2_Leaf)), (state_l (aut4.State_R (aut4.state_level1_L aut4.state_level2_Leaf)))), ((aut5.State_L (aut5.state_level1_L aut5.state_level2_Leaf)), (state_r (aut4.State_L (aut4.state_level1_L aut4.state_level2_Leaf)))) }"
