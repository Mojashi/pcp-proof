...
lemma aut3_append_char_automaton_1_state_split:
  obtains "s = (state_r aut3.State_Leaf)"|
...
abbreviation transition :: "State \<Rightarrow> alphabet \<Rightarrow> State" where
  ...
  ((state_l aut3.State_Leaf), C0) => (state_l (aut3.State_R aut3.state_level1_Leaf))|
  ((state_l (aut3.State_R aut3.state_level1_Leaf)), C1) => (state_r (aut3.State_R aut3.state_level1_Leaf))|
  ((state_l (aut3.State_R aut3.state_level1_Leaf)), C0) => (state_l (aut3.State_R aut3.state_level1_Leaf))|
  ((state_r aut3.State_Leaf), C1) => (state_r (aut3.State_R aut3.state_level1_Leaf))|
  ((state_r aut3.State_Leaf), C0) => (state_l (aut3.State_R aut3.state_level1_Leaf))|
  ((state_r (aut3.State_L aut3.state_level1_Leaf)), C1) => (state_r (aut3.State_L aut3.state_level1_Leaf))|
  ((state_r (aut3.State_L aut3.state_level1_Leaf)), C0) => (state_l (aut3.State_R aut3.state_level1_Leaf))|
  ((state_r (aut3.State_R aut3.state_level1_Leaf)), C1) => (state_r (aut3.State_L aut3.state_level1_Leaf))|
  ((state_r (aut3.State_R aut3.state_level1_Leaf)), C0) => (state_l (aut3.State_R aut3.state_level1_Leaf))|
  ((state_l (aut3.State_L aut3.state_level1_Leaf)), C1) => (state_r (aut3.State_L aut3.state_level1_Leaf))|
  ((state_l (aut3.State_L aut3.state_level1_Leaf)), C0) => (state_l (aut3.State_R aut3.state_level1_Leaf))"

definition aut3_append_char_automaton_1::"(alphabet, State) da" where
 "aut3_append_char_automaton_1 \<equiv> da (state_l aut3.State_Leaf) transition {(state_r (aut3.State_L aut3.state_level1_Leaf))}"
end