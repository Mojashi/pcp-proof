...
definition aut1_append_char_automaton_1_aut3_Invariant::"(aut1_append_char_automaton_1.State\<times>aut3.State) set" where
  "aut1_append_char_automaton_1_aut3_Invariant \<equiv> { ((state_l (aut1.State_L (aut1.state_level1_L aut1.state_level2_Leaf))), (aut3.State_R aut3.state_level1_Leaf)), ((state_l (aut1.State_R aut1.state_level1_Leaf)), (aut3.State_R aut3.state_level1_Leaf)), ((state_r (aut1.State_R (aut1.state_level1_L aut1.state_level2_Leaf))), (aut3.State_L aut3.state_level1_Leaf)), ((state_r (aut1.State_R (aut1.state_level1_R aut1.state_level2_Leaf))), (aut3.State_R aut3.state_level1_Leaf)), ((state_r aut1.State_Leaf), (aut3.State_L aut3.state_level1_Leaf)), ((state_r (aut1.State_L (aut1.state_level1_L aut1.state_level2_Leaf))), (aut3.State_L aut3.state_level1_Leaf)), ((state_r (aut1.State_R aut1.state_level1_Leaf)), (aut3.State_L aut3.state_level1_Leaf)), ((state_l (aut1.State_R (aut1.state_level1_R aut1.state_level2_Leaf))), aut3.State_Leaf), ((state_r (aut1.State_L aut1.state_level1_Leaf)), (aut3.State_L aut3.state_level1_Leaf)), ((state_r (aut1.State_L (aut1.state_level1_R aut1.state_level2_Leaf))), (aut3.State_L aut3.state_level1_Leaf)) }"
