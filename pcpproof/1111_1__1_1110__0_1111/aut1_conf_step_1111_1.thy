theory aut1_conf_step_1111_1
  imports Main "PCPLib.PCPAutomata" "aut1_conf" "aut7_conf" "pcp_instance" "aut6_pref_quotient_1" "aut1_append_word_1111"
begin
...
proof -
  have "lang (append_word aut1 tile_0_up) = lang aut6"
    by (simp only: aut1_append_word_1111 tile_0_up_def )
