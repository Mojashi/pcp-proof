...
definition aut5_append_char_automaton_1_aut6_Invariant::"(aut5_append_char_automaton_1.State\<times>aut6.State) set" where
  "aut5_append_char_automaton_1_aut6_Invariant \<equiv> { ((state_r (aut5.State_L (aut5.state_level1_R aut5.state_level2_Leaf))), (aut6.State_L aut6.state_level1_Leaf)), ((state_l (aut5.State_R (aut5.state_level1_R aut5.state_level2_Leaf))), (aut6.State_L (aut6.state_level1_L aut6.state_level2_Leaf))), ((state_r (aut5.State_L (aut5.state_level1_L aut5.state_level2_Leaf))), (aut6.State_R (aut6.state_level1_R aut6.state_level2_Leaf))), ((state_r aut5.State_Leaf), (aut6.State_R (aut6.state_level1_L aut6.state_level2_Leaf))), ((state_r (aut5.State_R (aut5.state_level1_L aut5.state_level2_Leaf))), (aut6.State_R aut6.state_level1_Leaf)), ((state_l (aut5.State_L (aut5.state_level1_R aut5.state_level2_Leaf))), (aut6.State_L (aut6.state_level1_R aut6.state_level2_Leaf))), ((state_r (aut5.State_R (aut5.state_level1_R aut5.state_level2_Leaf))), (aut6.State_L (aut6.state_level1_R aut6.state_level2_Leaf))) }"
