...
definition aut3_append_char_automaton_1_aut4_Invariant::"(aut3_append_char_automaton_1.State\<times>aut4.State) set" where
  "aut3_append_char_automaton_1_aut4_Invariant \<equiv> { ((state_r (aut3.State_R aut3.state_level1_Leaf)), (aut4.State_R (aut4.state_level1_R aut4.state_level2_Leaf))), ((state_l aut3.State_Leaf), (aut4.State_R (aut4.state_level1_L aut4.state_level2_Leaf))), ((state_r aut3.State_Leaf), (aut4.State_L (aut4.state_level1_L aut4.state_level2_Leaf))), ((state_l (aut3.State_R aut3.state_level1_Leaf)), (aut4.State_L (aut4.state_level1_L aut4.state_level2_Leaf))), ((state_r (aut3.State_L aut3.state_level1_Leaf)), (aut4.State_L (aut4.state_level1_R aut4.state_level2_Leaf))) }"
