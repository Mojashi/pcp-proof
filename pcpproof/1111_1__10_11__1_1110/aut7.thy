...
abbreviation transition::"State \<Rightarrow> alphabet \<Rightarrow> State" where
  ...
  ((aut7.State_L (aut7.state_level1_R aut7.state_level2_Leaf)), C1) => (aut7.State_L (aut7.state_level1_L aut7.state_level2_Leaf))|
  ((aut7.State_L (aut7.state_level1_R aut7.state_level2_Leaf)), C0) => (aut7.State_L (aut7.state_level1_R aut7.state_level2_Leaf))|
  ((aut7.State_L (aut7.state_level1_L aut7.state_level2_Leaf)), C1) => (aut7.State_R (aut7.state_level1_R aut7.state_level2_Leaf))|
  ((aut7.State_L (aut7.state_level1_L aut7.state_level2_Leaf)), C0) => (aut7.State_L (aut7.state_level1_R aut7.state_level2_Leaf))|
  (aut7.State_Leaf, C1) => (aut7.State_R (aut7.state_level1_L aut7.state_level2_Leaf))|
  (aut7.State_Leaf, C0) => (aut7.State_L (aut7.state_level1_R aut7.state_level2_Leaf))|
  ((aut7.State_R (aut7.state_level1_R aut7.state_level2_Leaf)), C1) => aut7.State_Leaf|
  ((aut7.State_R (aut7.state_level1_R aut7.state_level2_Leaf)), C0) => (aut7.State_L (aut7.state_level1_R aut7.state_level2_Leaf))|
  ((aut7.State_R (aut7.state_level1_L aut7.state_level2_Leaf)), C1) => (aut7.State_R (aut7.state_level1_L aut7.state_level2_Leaf))|
...
definition aut7::"(alphabet, State) da" where
 "aut7 \<equiv> da (aut7.State_L (aut7.state_level1_R aut7.state_level2_Leaf)) transition {(aut7.State_R (aut7.state_level1_L aut7.state_level2_Leaf))}"
end