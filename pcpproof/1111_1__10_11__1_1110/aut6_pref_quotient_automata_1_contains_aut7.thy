...
definition aut6_pref_quotient_automata_1_aut7_Invariant::"(aut6_pref_quotient_automata_1.State\<times>aut7.State) set" where
  "aut6_pref_quotient_automata_1_aut7_Invariant \<equiv> { ((aut6.State_R (aut6.state_level1_R aut6.state_level2_Leaf)), aut7.State_Leaf), ((aut6.State_L aut6.state_level1_Leaf), (aut7.State_L (aut7.state_level1_R aut7.state_level2_Leaf))), ((aut6.State_R aut6.state_level1_Leaf), (aut7.State_L (aut7.state_level1_L aut7.state_level2_Leaf))), ((aut6.State_L (aut6.state_level1_L aut6.state_level2_Leaf)), (aut7.State_R (aut7.state_level1_R aut7.state_level2_Leaf))), ((aut6.State_L (aut6.state_level1_R aut6.state_level2_Leaf)), (aut7.State_R (aut7.state_level1_L aut7.state_level2_Leaf))) }"
