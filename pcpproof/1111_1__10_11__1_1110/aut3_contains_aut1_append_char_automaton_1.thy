...
definition aut3_aut1_append_char_automaton_1_Invariant::"(aut3.State\<times>aut1_append_char_automaton_1.State) set" where
  "aut3_aut1_append_char_automaton_1_Invariant \<equiv> { ((aut3.State_L aut3.state_level1_Leaf), (state_l (aut1.State_R aut1.state_level1_Leaf))), ((aut3.State_R aut3.state_level1_Leaf), (state_r (aut1.State_R (aut1.state_level1_R aut1.state_level2_Leaf)))), (aut3.State_Leaf, (state_r (aut1.State_R aut1.state_level1_Leaf))), ((aut3.State_R aut3.state_level1_Leaf), (state_r (aut1.State_L (aut1.state_level1_L aut1.state_level2_Leaf)))), ((aut3.State_R aut3.state_level1_Leaf), (state_r (aut1.State_R (aut1.state_level1_L aut1.state_level2_Leaf)))), ((aut3.State_R aut3.state_level1_Leaf), (state_r (aut1.State_L (aut1.state_level1_R aut1.state_level2_Leaf)))), ((aut3.State_R aut3.state_level1_Leaf), (state_r (aut1.State_L aut1.state_level1_Leaf))), (aut3.State_Leaf, (state_l (aut1.State_R (aut1.state_level1_L aut1.state_level2_Leaf)))), (aut3.State_Leaf, (state_l (aut1.State_L (aut1.state_level1_L aut1.state_level2_Leaf)))) }"
