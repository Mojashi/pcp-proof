theory aut2_append_word_1110 
  imports Main "aut2" "aut16" "aut2_append_ch_1" "aut11_append_ch_1" "aut13_append_ch_1" "aut15_append_ch_0"
begin

lemma "aut2_append_word_1110": "lang (append_word aut2 [C1,C1,C1,C0]) = lang aut16"
proof -
  ...
  then have L3:"lang (append_word_rev aut2 [C1,C1,C1]) = lang aut15"
  ...
  then have "lang (append_word_rev aut2 [C0,C1,C1,C1]) = lang (append_ch aut15 C0)"
    by (simp only: L3 append_ch_hom[of "append_word_rev aut2 [C1,C1,C1]" aut15 C0] )
  then have L4:"lang (append_word_rev aut2 [C0,C1,C1,C1]) = lang aut16"
    by (simp only: aut15_append_ch_0 )
