theory closed
  imports Main "PCPLib.PCP" "PCPLib.PCPTrans" "aut1_conf" "aut2_conf" "aut1_conf_step_1111_1" "aut1_conf_step_10_11" "aut1_conf_step_1_1110" "aut2_conf_step_1111_1" "aut2_conf_step_10_11" "aut2_conf_step_1_1110"  "pcp_instance" "aut1_contains_aut7" "aut1_contains_aut9" "aut1_contains_aut10" "accept_aut2_conf_DN_10" "accept_aut2_conf_DN_0" "aut2_contains_aut12" "accept_aut1_conf_UP_11" "accept_aut1_conf_UP_1" "aut2_contains_aut14" "aut2_contains_aut17" inv
begin
    ...
    proof (cases)
      ...
      then show ?thesis proof (cases)
        ...
        then have B2:"... \<subseteq> (lang_autconf aut1_conf)\<union>(lang_autconf aut1_conf)\<union>{}" 
          by (simp add: accept_aut1_conf_UP_11 accept_aut1_conf_UP_1 aut2_conf_step_1111_1.stepped_confs_def)
      ...
      then show ?thesis proof (cases)
        ...
        case s0
        have A1:"lang_autconf (fst (step_autconf_tile aut1_conf t)) = lang_autconf aut9_conf"
          by (simp only: aut1_conf_step_10_11.is_stepped_autconf t1 )

        then have A2:"... \<subseteq> lang_autconf aut1_conf"
          apply (simp only: aut1_conf_def aut9_conf_def )
          using  aut1_contains_aut9 by auto

        have B1:"snd (step_autconf_tile aut1_conf t) = aut1_conf_step_10_11.stepped_confs" 
          by (simp only: aut1_conf_step_10_11.is_stepped_configs t1 )
        
        then have B2:"... \<subseteq> {}" 
          by (simp add:  aut1_conf_step_10_11.stepped_confs_def)
        ...
        case s1
        have A1:"lang_autconf (fst (step_autconf_tile aut2_conf t)) = lang_autconf aut14_conf"
          by (simp only: aut2_conf_step_10_11.is_stepped_autconf t1 )

        then have A2:"... \<subseteq> lang_autconf aut2_conf"
          apply (simp only: aut2_conf_def aut14_conf_def )
          using  aut2_contains_aut14 by auto

        have B1:"snd (step_autconf_tile aut2_conf t) = aut2_conf_step_10_11.stepped_confs" 
          by (simp only: aut2_conf_step_10_11.is_stepped_configs t1 )
        
        then have B2:"... \<subseteq> {}" 
          by (simp add:  aut2_conf_step_10_11.stepped_confs_def)
      ...
      then show ?thesis proof (cases)
        ...
        have A1:"lang_autconf (fst (step_autconf_tile aut1_conf t)) = lang_autconf aut10_conf"
          by (simp only: aut1_conf_step_1_1110.is_stepped_autconf t2 )
        ...
        have B1:"snd (step_autconf_tile aut1_conf t) = aut1_conf_step_1_1110.stepped_confs" 
          by (simp only: aut1_conf_step_1_1110.is_stepped_configs t2 )
        ...
        case s1
        have A1:"lang_autconf (fst (step_autconf_tile aut2_conf t)) = lang_autconf aut17_conf"
          by (simp only: aut2_conf_step_1_1110.is_stepped_autconf t2 )

        then have A2:"... \<subseteq> lang_autconf aut2_conf"
          apply (simp only: aut2_conf_def aut17_conf_def )
          using  aut2_contains_aut17 by auto

        have B1:"snd (step_autconf_tile aut2_conf t) = aut2_conf_step_1_1110.stepped_confs" 
          by (simp only: aut2_conf_step_1_1110.is_stepped_configs t2 )
