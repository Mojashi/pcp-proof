...
definition aut1_aut7_Invariant::"(aut1.State\<times>aut7.State) set" where
  "aut1_aut7_Invariant \<equiv> { ((aut1.State_R aut1.state_level1_Leaf), (aut7.State_L (aut7.state_level1_R aut7.state_level2_Leaf))), ((aut1.State_L aut1.state_level1_Leaf), (aut7.State_R (aut7.state_level1_L aut7.state_level2_Leaf))), ((aut1.State_L (aut1.state_level1_L aut1.state_level2_Leaf)), (aut7.State_L (aut7.state_level1_R aut7.state_level2_Leaf))), ((aut1.State_L aut1.state_level1_Leaf), aut7.State_Leaf), ((aut1.State_L (aut1.state_level1_R aut1.state_level2_Leaf)), (aut7.State_R (aut7.state_level1_R aut7.state_level2_Leaf))), ((aut1.State_R (aut1.state_level1_L aut1.state_level2_Leaf)), (aut7.State_L (aut7.state_level1_R aut7.state_level2_Leaf))), ((aut1.State_R (aut1.state_level1_R aut1.state_level2_Leaf)), (aut7.State_L (aut7.state_level1_L aut7.state_level2_Leaf))), ((aut1.State_L aut1.state_level1_Leaf), (aut7.State_L (aut7.state_level1_L aut7.state_level2_Leaf))), ((aut1.State_L aut1.state_level1_Leaf), (aut7.State_R (aut7.state_level1_R aut7.state_level2_Leaf))) }"
