theory aut1_append_word_1110 
  imports Main "aut1" "aut6" "aut1_append_ch_1" "aut3_append_ch_1" "aut4_append_ch_1" "aut5_append_ch_0"
begin

lemma "aut1_append_word_1110": "lang (append_word aut1 [C1,C1,C1,C0]) = lang aut6"
proof -
  ...
  have "lang (append_word_rev aut1 [C0,C1,C1,C1]) = lang (append_ch (append_word_rev aut1 [C1,C1,C1]) C0)"
    by (simp only: append_word_lang_rev_to_ch[of "aut1" C0 "[C1,C1,C1]"] )
  then have "lang (append_word_rev aut1 [C0,C1,C1,C1]) = lang (append_ch aut5 C0)"
    by (simp only: L3 append_ch_hom[of "append_word_rev aut1 [C1,C1,C1]" aut5 C0] )
  then have L4:"lang (append_word_rev aut1 [C0,C1,C1,C1]) = lang aut6"
    by (simp only: aut5_append_ch_0 )


  have "rev [C1,C1,C1,C0] = [C0,C1,C1,C1]" by simp
  then have "append_word aut1 [C1,C1,C1,C0] = append_word_rev aut1 [C0,C1,C1,C1]" 
    by (simp only: append_word_rev_is_rev[of aut1 "[C1,C1,C1,C0]"])
