theory aut2_append_ch_1 
  imports Main "aut2" "aut12" "aut2_append_char_automaton_1" "aut2_append_char_automaton_1_eq_aut12"
begin
...
lemma "aut2_append_ch_1": "lang (append_ch aut2 C1) = lang aut12"
  using aut2_append_char_automaton_1_eq_aut12 append_ch_eq by simp
end